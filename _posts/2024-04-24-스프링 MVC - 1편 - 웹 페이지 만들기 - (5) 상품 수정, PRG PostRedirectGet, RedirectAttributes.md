...
![](https://i.imgur.com/Xm5eb4y.png){: .align-center}

  

![](https://i.imgur.com/l5oCVOs.png){: .align-center}
...
그래서 저장이 잘 되었으면 상품 상세 화면에서 `저장완료!` 라는 메시지를 보여달라는 요구사항이 왔다.
...
그리고 뷰 템플릿에서 이 값이 있으면, `저장 완료!` 라는 메시지를 출력 해보자.
...
(2024.03.09 ~ 2024.04.24 매일 아침 30분 ~ 1시간..)
